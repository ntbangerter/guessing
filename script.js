...
function handleGuess() {
	...
	previousGuesses.add(guess);
        ...
        li.textContent = guess.toUpperCase();
	    ...
	    document.getElementById('giveUp').disabled = true;
            ...
            document.getElementById('guesses_before').appendChild(li);
	    sortList('guesses_before');
        } else {
            document.getElementById('guesses_after').appendChild(li);
